...
${OBJECTDIR}/include/Scene_1.o: include/Scene_1.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Scene_1.o include/Scene_1.cpp
...
${OBJECTDIR}/include/Scene_1_nomain.o: ${OBJECTDIR}/include/Scene_1.o include/Scene_1.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2`   -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Scene_1_nomain.o include/Scene_1.cpp;\
	else  \
