...
${OBJECTDIR}/include/Camera.o: include/Camera.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Camera.o include/Camera.cpp

${OBJECTDIR}/include/HitTrace.o: include/HitTrace.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/HitTrace.o include/HitTrace.cpp

${OBJECTDIR}/include/Hittable.o: include/Hittable.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Hittable.o include/Hittable.cpp

${OBJECTDIR}/include/Material.o: include/Material.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Material.o include/Material.cpp
...
${OBJECTDIR}/include/Ray.o: include/Ray.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Ray.o include/Ray.cpp

${OBJECTDIR}/include/Renderer.o: include/Renderer.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Renderer.o include/Renderer.cpp

${OBJECTDIR}/include/Scene.o: include/Scene.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Scene.o include/Scene.cpp

${OBJECTDIR}/include/Sphere.o: include/Sphere.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Sphere.o include/Sphere.cpp

${OBJECTDIR}/include/Triangle.o: include/Triangle.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Triangle.o include/Triangle.cpp

${OBJECTDIR}/include/Window.o: include/Window.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Window.o include/Window.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
...
${TESTDIR}/tests/CameraTest.o: tests/CameraTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CameraTest.o tests/CameraTest.cpp


${TESTDIR}/tests/RotationsTest.o: tests/RotationsTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. `pkg-config --cflags sdl2` -std=c++14  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RotationsTest.o tests/RotationsTest.cpp
...
${OBJECTDIR}/include/Camera_nomain.o: ${OBJECTDIR}/include/Camera.o include/Camera.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Camera_nomain.o include/Camera.cpp;\
	else  \
...
${OBJECTDIR}/include/HitTrace_nomain.o: ${OBJECTDIR}/include/HitTrace.o include/HitTrace.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/HitTrace_nomain.o include/HitTrace.cpp;\
	else  \
...
${OBJECTDIR}/include/Hittable_nomain.o: ${OBJECTDIR}/include/Hittable.o include/Hittable.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Hittable_nomain.o include/Hittable.cpp;\
	else  \
...
${OBJECTDIR}/include/Material_nomain.o: ${OBJECTDIR}/include/Material.o include/Material.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Material_nomain.o include/Material.cpp;\
	else  \
...
${OBJECTDIR}/include/Ray_nomain.o: ${OBJECTDIR}/include/Ray.o include/Ray.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Ray_nomain.o include/Ray.cpp;\
	else  \
...
${OBJECTDIR}/include/Renderer_nomain.o: ${OBJECTDIR}/include/Renderer.o include/Renderer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Renderer_nomain.o include/Renderer.cpp;\
	else  \
...
${OBJECTDIR}/include/Scene_nomain.o: ${OBJECTDIR}/include/Scene.o include/Scene.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Scene_nomain.o include/Scene.cpp;\
	else  \
...
${OBJECTDIR}/include/Sphere_nomain.o: ${OBJECTDIR}/include/Sphere.o include/Sphere.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Sphere_nomain.o include/Sphere.cpp;\
	else  \
...
${OBJECTDIR}/include/Triangle_nomain.o: ${OBJECTDIR}/include/Triangle.o include/Triangle.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Triangle_nomain.o include/Triangle.cpp;\
	else  \
...
${OBJECTDIR}/include/Window_nomain.o: ${OBJECTDIR}/include/Window.o include/Window.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Window_nomain.o include/Window.cpp;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude `pkg-config --cflags sdl2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
