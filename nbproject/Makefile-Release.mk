...
${OBJECTDIR}/include/RandomVector.o: include/RandomVector.cc
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/RandomVector.o include/RandomVector.cc
...
${OBJECTDIR}/include/RandomVector_nomain.o: ${OBJECTDIR}/include/RandomVector.o include/RandomVector.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/RandomVector_nomain.o include/RandomVector.cc;\
	else  \
